								...
								<div class="ibox float-e-margins">
									...
									<div class="ibox-content">
										...
										<div class="widget-toolbox padding-8" style="width: 100%;margin-bottom: 15px;">
											<textarea id="key_word" class="form-control" placeholder="请输入关键词" >${dataModel.key_word}</textarea>
										</div>
...
<textarea id="reply_content" style="display: none;">
		${dataModel.reply_content}
	</textarea>
    <input type="hidden" id="replyId" value="${dataModel.id}"/>
	<!-- basic scripts -->
	<!-- 页面底部js¨ -->
