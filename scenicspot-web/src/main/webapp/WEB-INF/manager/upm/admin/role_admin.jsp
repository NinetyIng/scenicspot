				...
				<div class="ibox">
					<div class="ibox-title">
						...
						<div class="ibox-tools">
							<a href="/test/editPage.do.do" class="btn btn-primary btn-xs"><i class="fa fa-plus"></i>&nbsp;新增角色</a>
						</div>
					</div>
											...
											<c:when test="${not empty varList}">
												<c:forEach items="${varList}" var="item">
													<tr>
														...
														<td class="center">
															<a href="/sys/upm/role/edit.do?id=${item.role_id}" class="btn btn-primary btn-sm" title="编辑">
                           										<i class="fa fa-pencil"></i>
                       										</a>
                       										<a href="/sys/upm/role/delete.do?type_id=${item.role_id}" class="btn btn-warning btn-sm" title="删除">
